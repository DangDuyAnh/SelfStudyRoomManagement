...
export const InputField = ({ secured, placeholder, isLastInputField, keyName, val, onChangeVal, numeric }) => {
    ...
    >
      {secured ? (
        <View style={{flexDirection: "row", alignItems: "center"}}>
          ...
          />
          <EyeOpen setSeePassword={setSeePassword} seePassword={seePassword}/>
        </View>
      ) : (
        numeric ? <TextInput
        value={val}
